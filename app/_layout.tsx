                ...
                <Stack.Screen
                  ...
                  options={{
                    ...
                    headerLeft: () => (
                      <TouchableOpacity
                        onPress={() => router.back()}
                        className="w-32 h-24 flex justify-center"
                      >
                        <Image
                          source={icons.x}
